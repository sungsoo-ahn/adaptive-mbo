...
@cli.command()
@click.option("--local-dir", type=str, default="continual-molecule")
...
def molecule(local_dir, cpus, gpus, num_parallel, num_samples):
    ...
    from design_baselines.continual import continual
...
@cli.command()
@click.option("--local-dir", type=str, default="continual-gfp")
@click.option("--cpus", type=int, default=24)
@click.option("--gpus", type=int, default=1)
@click.option("--num-parallel", type=int, default=1)
@click.option("--num-samples", type=int, default=1)
def gfp(local_dir, cpus, gpus, num_parallel, num_samples):
    ...
    tune.run(
        ...
        config={
            ...
            "inner_steps": 1000,
            "min_fim": 0.1,
            "ewc_coef": tune.grid_search([1000.0, 100.0]),
            "huber_delta": tune.grid_search([1e-3, 1e-2, 1e-1, 1.0]),
        },
        num_samples=num_samples,
        local_dir=local_dir,
        resources_per_trial={"cpu": cpus // num_parallel, "gpu": gpus / num_parallel - 0.01},
...
@cli.command()
@click.option("--local-dir", type=str, default="continual-gfp-v1")
@click.option("--cpus", type=int, default=24)
@click.option("--gpus", type=int, default=1)
@click.option("--num-parallel", type=int, default=1)
@click.option("--num-samples", type=int, default=1)
...
@cli.command()
@click.option("--local-dir", type=str, default="continual-dkitty")
@click.option("--cpus", type=int, default=24)
@click.option("--gpus", type=int, default=1)
@click.option("--num-parallel", type=int, default=1)
@click.option("--num-samples", type=int, default=1)
...
@cli.command()
@click.option("--local-dir", type=str, default="continual-ant")
@click.option("--cpus", type=int, default=24)
@click.option("--gpus", type=int, default=1)
@click.option("--num-parallel", type=int, default=1)
@click.option("--num-samples", type=int, default=1)
...
@cli.command()
@click.option("--local-dir", type=str, default="continual-hopper")
@click.option("--cpus", type=int, default=24)
@click.option("--gpus", type=int, default=1)
@click.option("--num-parallel", type=int, default=1)
@click.option("--num-samples", type=int, default=1)
...
@cli.command()
@click.option("--local-dir", type=str, default="continual-superconductor")
@click.option("--cpus", type=int, default=24)
@click.option("--gpus", type=int, default=1)
@click.option("--num-parallel", type=int, default=1)
@click.option("--num-samples", type=int, default=1)
