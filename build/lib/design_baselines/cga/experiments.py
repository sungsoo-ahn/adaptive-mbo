...
@cli.command()
@click.option("--local-dir", type=str, default="cga-molecule")
...
def molecule(local_dir, cpus, gpus, num_parallel, num_samples):
    ...
    from design_baselines.cga import cga
...
@cli.command()
@click.option("--local-dir", type=str, default="cga-gfp")
@click.option("--cpus", type=int, default=24)
@click.option("--gpus", type=int, default=1)
@click.option("--num-parallel", type=int, default=1)
@click.option("--num-samples", type=int, default=1)
...
@cli.command()
@click.option("--local-dir", type=str, default="cga-dkitty")
@click.option("--cpus", type=int, default=24)
@click.option("--gpus", type=int, default=1)
@click.option("--num-parallel", type=int, default=1)
@click.option("--num-samples", type=int, default=1)
...
@cli.command()
@click.option("--local-dir", type=str, default="cga-ant")
@click.option("--cpus", type=int, default=24)
@click.option("--gpus", type=int, default=1)
@click.option("--num-parallel", type=int, default=1)
@click.option("--num-samples", type=int, default=1)
...
@cli.command()
@click.option("--local-dir", type=str, default="cga-hopper")
@click.option("--cpus", type=int, default=24)
@click.option("--gpus", type=int, default=1)
@click.option("--num-parallel", type=int, default=1)
@click.option("--num-samples", type=int, default=1)
...
@cli.command()
@click.option("--local-dir", type=str, default="cga-superconductor")
@click.option("--cpus", type=int, default=24)
@click.option("--gpus", type=int, default=1)
@click.option("--num-parallel", type=int, default=1)
@click.option("--num-samples", type=int, default=1)
def superconductor(local_dir, cpus, gpus, num_parallel, num_samples):
    ...
    tune.run(
        ...
        config={
            ...
            "initial_min_std": 0.1,
            "forward_model_lr": 0.001,
            "alpha": tune.grid_search([1e-4, 1e-3, 1e-2, 1e-1]),
            "solver_lr": 1e-1,
            "solver_noise_penalty": 0.0,
            "solver_update_freq": 1,
            "eval_freq": 1,
        },
        num_samples=num_samples,
