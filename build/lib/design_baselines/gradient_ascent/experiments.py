...
def normalized_hopper(local_dir, cpus, gpus, num_parallel, num_samples):
    ...
    tune.run(
        ...
        config={
            ...
            "aggregation_method": "mean",
            "solver_samples": 128,
            "solver_lr": tune.grid_search([0.1, 0.05, 0.02, 0.01, 0.005, 0.002, 0.001, 0.0005]),
            "solver_steps": 1000,
        },
        num_samples=num_samples,
        local_dir=local_dir,
...
def unnormalized_hopper(local_dir, cpus, gpus, num_parallel, num_samples):
    ...
    tune.run(
        ...
        config={
            ...
            "aggregation_method": "mean",
            "solver_samples": 128,
            "solver_lr": tune.grid_search(
                [0.00005, 0.00002, 0.00001, 0.000005, 0.000002, 0.000001, 0.0000005, 0.0000002]
            ),
            "solver_steps": 200,
        },
        num_samples=num_samples,
