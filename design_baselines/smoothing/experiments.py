...
@cli.command()
@click.option("--local-dir", type=str, default="smoothing-molecule")
...
def molecule(local_dir, cpus, gpus, num_parallel, num_samples):
    ...
    from design_baselines.smoothing import smoothing
...
@cli.command()
@click.option("--local-dir", type=str, default="smoothing-gfp")
@click.option("--cpus", type=int, default=24)
@click.option("--gpus", type=int, default=1)
@click.option("--num-parallel", type=int, default=1)
@click.option("--num-samples", type=int, default=1)
...
@cli.command()
@click.option("--local-dir", type=str, default="smoothing-superconductor")
@click.option("--cpus", type=int, default=24)
@click.option("--gpus", type=int, default=1)
@click.option("--num-parallel", type=int, default=1)
@click.option("--num-samples", type=int, default=1)
...
@cli.command()
@click.option("--local-dir", type=str, default="smoothing-dkitty")
@click.option("--cpus", type=int, default=24)
@click.option("--gpus", type=int, default=1)
@click.option("--num-parallel", type=int, default=1)
@click.option("--num-samples", type=int, default=1)
...
@cli.command()
@click.option("--local-dir", type=str, default="smoothing-ant")
@click.option("--cpus", type=int, default=24)
@click.option("--gpus", type=int, default=1)
@click.option("--num-parallel", type=int, default=1)
@click.option("--num-samples", type=int, default=1)
...
@cli.command()
@click.option("--local-dir", type=str, default="smoothing-hopper")
@click.option("--cpus", type=int, default=24)
@click.option("--gpus", type=int, default=1)
@click.option("--num-parallel", type=int, default=1)
@click.option("--num-samples", type=int, default=1)
