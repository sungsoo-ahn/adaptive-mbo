...
@cli.command()
@click.option("--local-dir", type=str, default="rebm-molecule")
...
def molecule(local_dir, cpus, gpus, num_parallel, num_samples):
    ...
    from design_baselines.rebm import rebm
    ...
    tune.run(
        ...
        config={
            ...
            "epochs": 500,
            "hidden_size": 2048,
            "forward_model_lr": tune.grid_search([0.001, 0.01]),
            "sgld_lr": tune.grid_search([1e-3, 1e-4, 1e-5]),
            "sgld_noise_penalty": 0.0,
            "sgld_train_steps": 100,
            "sgld_eval_steps": 100,
            "init_noise_std": 1.0,
        },
...
@cli.command()
@click.option("--local-dir", type=str, default="rebm-gfp")
@click.option("--cpus", type=int, default=24)
@click.option("--gpus", type=int, default=1)
@click.option("--num-parallel", type=int, default=1)
@click.option("--num-samples", type=int, default=1)
...
@cli.command()
@click.option("--local-dir", type=str, default="rebm-dkitty")
@click.option("--cpus", type=int, default=24)
@click.option("--gpus", type=int, default=1)
@click.option("--num-parallel", type=int, default=1)
@click.option("--num-samples", type=int, default=1)
...
@cli.command()
@click.option("--local-dir", type=str, default="rebm-ant")
@click.option("--cpus", type=int, default=24)
@click.option("--gpus", type=int, default=1)
@click.option("--num-parallel", type=int, default=1)
@click.option("--num-samples", type=int, default=1)
...
@cli.command()
@click.option("--local-dir", type=str, default="rebm-hopper")
@click.option("--cpus", type=int, default=24)
@click.option("--gpus", type=int, default=1)
@click.option("--num-parallel", type=int, default=1)
@click.option("--num-samples", type=int, default=1)
...
@cli.command()
@click.option("--local-dir", type=str, default="rebm-superconductor")
@click.option("--cpus", type=int, default=24)
@click.option("--gpus", type=int, default=1)
@click.option("--num-parallel", type=int, default=1)
@click.option("--num-samples", type=int, default=1)
